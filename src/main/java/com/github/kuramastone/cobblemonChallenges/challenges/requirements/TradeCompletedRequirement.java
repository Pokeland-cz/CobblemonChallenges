...
public class TradeCompletedRequirement implements Requirement {
    ...
    public Progression<?> buildProgression(PlayerProfile profile, Challenge parentChallenge) {
        return new TradesCompletedProgression(profile, this, parentChallenge);
    }
    ...
    public static class TradesCompletedProgression implements Progression<TradeEvent.Post> {
        ...
        public TradeCompletedRequirement requirement;
        private int progressAmount;
        private Challenge parentChallenge;

        public TradesCompletedProgression(PlayerProfile profile, TradeCompletedRequirement requirement, Challenge parentChallenge) {
