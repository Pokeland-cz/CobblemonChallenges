...
public class HatchEggRequirement implements Requirement {
    ...
    public Progression<?> buildProgression(PlayerProfile profile, Challenge parentChallenge) {
        return new HatchEggProgression(profile, this, parentChallenge);
    }
    ...
    public static class HatchEggProgression implements Progression<HatchEggEvent.Post> {
        ...
        public HatchEggProgression(PlayerProfile profile, HatchEggRequirement requirement, Challenge parentChallenge) {
